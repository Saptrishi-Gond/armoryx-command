...
export const countryPower = [
  ...
  { country: "South Korea", code: "🇰🇷", power: 62, change: 2.1 },
  { country: "Japan", code: "🇯🇵", power: 60, change: 1.8 },
  { country: "Turkey", code: "🇹🇷", power: 58, change: 3.5 },
  { country: "Germany", code: "🇩🇪", power: 56, change: 2.0 },
  { country: "Italy", code: "🇮🇹", power: 53, change: 0.5 },
  { country: "Australia", code: "🇦🇺", power: 51, change: 1.9 },
  { country: "Brazil", code: "🇧🇷", power: 48, change: 0.3 },
  { country: "Iran", code: "🇮🇷", power: 46, change: 2.5 },
  { country: "North Korea", code: "🇰🇵", power: 44, change: 1.0 },
  { country: "Sweden", code: "🇸🇪", power: 42, change: 0.8 },
  { country: "Norway", code: "🇳🇴", power: 40, change: 0.6 },
  { country: "Poland", code: "🇵🇱", power: 38, change: 3.0 },
  { country: "Taiwan", code: "🇹🇼", power: 37, change: 1.5 },
  { country: "Saudi Arabia", code: "🇸🇦", power: 36, change: 0.9 },
  { country: "Egypt", code: "🇪🇬", power: 35, change: 0.4 },
  { country: "Spain", code: "🇪🇸", power: 34, change: 0.3 },
  { country: "Singapore", code: "🇸🇬", power: 32, change: 1.2 },
];
...
export const countryMapData = [
  { country: "USA", code: "🇺🇸", rank: 1, weapons: allWeapons.filter(w => w.country === "USA" || w.country.includes("USA")).length, air: 520, naval: 380, drones: 340, nuclear: 180 },
  { country: "Russia", code: "🇷🇺", rank: 2, weapons: allWeapons.filter(w => w.country === "Russia" || w.country.includes("Russia")).length, air: 480, naval: 290, drones: 280, nuclear: 300 },
  { country: "China", code: "🇨🇳", rank: 3, weapons: allWeapons.filter(w => w.country === "China").length, air: 420, naval: 350, drones: 310, nuclear: 100 },
  { country: "India", code: "🇮🇳", rank: 4, weapons: allWeapons.filter(w => w.country === "India" || w.country.includes("India")).length, air: 280, naval: 180, drones: 200, nuclear: 120 },
  { country: "UK", code: "🇬🇧", rank: 5, weapons: allWeapons.filter(w => w.country === "UK" || w.country.includes("UK")).length, air: 180, naval: 150, drones: 120, nuclear: 70 },
  { country: "France", code: "🇫🇷", rank: 6, weapons: allWeapons.filter(w => w.country === "France" || w.country.includes("France")).length, air: 170, naval: 140, drones: 110, nuclear: 70 },
  ...
  { country: "South Korea", code: "🇰🇷", rank: 9, weapons: allWeapons.filter(w => w.country === "South Korea").length, air: 90, naval: 60, drones: 40, nuclear: 0 },
  { country: "Japan", code: "🇯🇵", rank: 10, weapons: allWeapons.filter(w => w.country === "Japan").length, air: 85, naval: 55, drones: 30, nuclear: 0 },
  { country: "Germany", code: "🇩🇪", rank: 11, weapons: allWeapons.filter(w => w.country === "Germany").length, air: 80, naval: 40, drones: 25, nuclear: 0 },
  { country: "Pakistan", code: "🇵🇰", rank: 12, weapons: allWeapons.filter(w => w.country === "Pakistan").length, air: 60, naval: 30, drones: 20, nuclear: 80 },
  { country: "Australia", code: "🇦🇺", rank: 13, weapons: allWeapons.filter(w => w.country === "Australia").length, air: 50, naval: 45, drones: 20, nuclear: 0 },
  { country: "Italy", code: "🇮🇹", rank: 14, weapons: allWeapons.filter(w => w.country === "Italy").length, air: 45, naval: 35, drones: 15, nuclear: 0 },
  { country: "Iran", code: "🇮🇷", rank: 15, weapons: allWeapons.filter(w => w.country === "Iran").length, air: 40, naval: 25, drones: 60, nuclear: 0 },
  { country: "Sweden", code: "🇸🇪", rank: 16, weapons: allWeapons.filter(w => w.country === "Sweden").length, air: 35, naval: 20, drones: 10, nuclear: 0 },
  { country: "North Korea", code: "🇰🇵", rank: 17, weapons: allWeapons.filter(w => w.country === "North Korea").length, air: 30, naval: 15, drones: 10, nuclear: 50 },
  { country: "Norway", code: "🇳🇴", rank: 18, weapons: allWeapons.filter(w => w.country === "Norway").length, air: 25, naval: 15, drones: 8, nuclear: 0 },
  { country: "Poland", code: "🇵🇱", rank: 19, weapons: allWeapons.filter(w => w.country === "Poland").length, air: 20, naval: 10, drones: 5, nuclear: 0 },
  { country: "Brazil", code: "🇧🇷", rank: 20, weapons: allWeapons.filter(w => w.country === "Brazil").length, air: 30, naval: 20, drones: 5, nuclear: 0 },
  { country: "Taiwan", code: "🇹🇼", rank: 21, weapons: allWeapons.filter(w => w.country === "Taiwan").length, air: 25, naval: 15, drones: 10, nuclear: 0 },
  { country: "Saudi Arabia", code: "🇸🇦", rank: 22, weapons: allWeapons.filter(w => w.country === "Saudi Arabia").length, air: 40, naval: 15, drones: 8, nuclear: 0 },
  { country: "Egypt", code: "🇪🇬", rank: 23, weapons: allWeapons.filter(w => w.country === "Egypt").length, air: 35, naval: 15, drones: 5, nuclear: 0 },
  { country: "Spain", code: "🇪🇸", rank: 24, weapons: allWeapons.filter(w => w.country === "Spain").length, air: 25, naval: 20, drones: 5, nuclear: 0 },
  { country: "Singapore", code: "🇸🇬", rank: 25, weapons: allWeapons.filter(w => w.country === "Singapore").length, air: 15, naval: 10, drones: 8, nuclear: 0 },
];
